...
public:
    Item() : m_var{0}
    {
        std::cout << "Item default constructor called for " << std::endl;
    }
    Item(int var) : m_var(var)
    {
        std::cout << "Item constructor called for: " << m_var << std::endl;
    }
    Item(int var_1, int var_2) : m_var{var_1 * var_2}
    {
    }
...
int main()
{
    ...
    std::vector<Item> items = {Item(6), Item(7), Item(8), Item(9), Item(10), Item()};
