...
/* A priority queue is a container adaptor that allows accessing the largest and smallest elements
in a queue in constant time O(1), it is sorted in a descending order(The largest is at the top and
the smallest is at the bottom). It is called a container adaptor because internaally it is
implementing the vector container as a tree. */
