...
/* List in STL can be called doubly-linked list, which ,means we can traverse fporward and
backward. List is a sequence container that provides non-contigious memory allocation ability.
*/
...
void print_collection(const T &collection)
{
    ...
    auto element = collection.begin();

    std::cout << " Collection [";
    while (element != collection.end())
    {
        std::cout << " " << *element;
        ++element;
    }
...
int main()
{
    ...
    std::list<std::string> words = {"Cat", "Animal", "Ant", "Zebra", "Shark"};
