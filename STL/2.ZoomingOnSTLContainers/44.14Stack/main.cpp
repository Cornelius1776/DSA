...
/* The stack container adaptor allows proviveds the functionality of the stack data struture LIFO (
    last in , firstout). it is called a container adaptor because it can be implemented with vector,
    or deque internally. */
