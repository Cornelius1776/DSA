...
int main()
{
    ...
    // Copy from source to destination(dest)
    ...
    std::vector<int> dest_1 = {100, 200, 300, 400, 500, 600};

    std::cout << "source : ";
    print_collection(source);

    std::cout << "dest_1 : ";
    print_collection(dest_1);
    ...
    std::copy_if(std::begin(source), std::end(source), std::begin(dest_1), odd);

    std::cout << "source(after copy_if) : ";
    print_collection(source);

    std::cout << "dest_1(after copy_if) : ";
    print_collection(dest_1);
